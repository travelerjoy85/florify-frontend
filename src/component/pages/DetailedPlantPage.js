  ...
  render() { // render chart
    ...
    return(
      <div className='DetailedPlantPage'>
            <Collection className='DetialedPlantPage-content' header= { nickname }>
              <CollectionItem className="DetailedPlantPage-info-box">{ name }</CollectionItem>
              <CollectionItem className="DetailedPlantPage-info-box">{ description }</CollectionItem>
              <CollectionItem className={ this.state[util.HUMIDITY] ? "DetailedPlantPage-info-hum-toggled" : "DetailedPlantPage-info-box" }
            ...
            <CollectionItem className={ this.state[util.LUX] ? "DetailedPlantPage-info-lux-toggled" : "DetailedPlantPage-info-box" }
            ...
            <CollectionItem className={ this.state[util.FERTILITY] ? "DetailedPlantPage-info-ph-toggled" : "DetailedPlantPage-info-box" }
